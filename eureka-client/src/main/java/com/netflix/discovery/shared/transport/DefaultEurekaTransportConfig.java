...
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.APPLICATION_RESOLVER_USE_IP_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.ASYNC_EXECUTOR_THREADPOOL_SIZE_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.ASYNC_RESOLVER_REFRESH_INTERVAL_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.ASYNC_RESOLVER_WARMUP_TIMEOUT_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.BOOTSTRAP_RESOLVER_STRATEGY_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.DATA_STALENESS_THRESHOLD_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.QUARANTINE_REFRESH_PERCENTAGE_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.READ_CLUSTER_VIP_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.SESSION_RECONNECT_INTERVAL_KEY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.TRANSPORT_CONFIG_SUB_NAMESPACE;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.USE_BOOTSTRAP_RESOLVER_FOR_QUERY;
import static com.netflix.discovery.shared.transport.PropertyBasedTransportConfigConstants.WRITE_CLUSTER_VIP_KEY;
